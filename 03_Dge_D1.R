...
pdf("d1_dge/PCA_D1.pdf",width=6,height=6,useDingbats=FALSE)
...
fitEb = eBayes(fitLM);
D1_FullTab = topTable(fitEb, coef = "GenotypeWT",number=nrow(p)) %>%
...
save(D1_FullTab,D1_DGE, file = "d1_dge/D1_Dge_Data.RData")


openxlsx::write.xlsx(D1_FullTab, 
                     file = "d1_dge/D1_DGE_FullStats.xlsx", 
                     colNames = TRUE,
                     rowNames = FALSE, 
                     borders = "columns",
                     sheetName="Stats",
...
openxlsx::write.xlsx(D1_DGE, 
                     file = "d1_dge/D1_DGE.xlsx", 
                     colNames = TRUE,
                     rowNames = FALSE, 
                     borders = "columns",
                     sheetName="Stats",
...
write.table(p_regressed,"d1_dge/expression_regressed.txt",sep="\t",quote=F)

pdf("d1_dge/PCA_D1_AdjustedForConfound.pdf",width=6,height=6,useDingbats=FALSE)
...
pdf("d1_dge/Boxplots_TopGenes_D1.pdf",width=6,height=5,useDingbats=FALSE)
...
pdf("d1_dge/Vulcano_Plot_D1.pdf",width=6,height=6,useDingbats=FALSE)
ggscatter(df, 
            x = "logFC", 
            y = "LOG",
            color = "Threshold",
...
pdf("d1_dge/Heatmap_D1.pdf",width=4,height=6)
